...
public class SicboSessionResponse {
    ...
    public static SicboSessionResponse idle(Instant referenceTime) {
        return SicboSessionResponse.builder()
                .status("IDLE")
                .phase("idle")
                .phaseLabel("")
    ...
    public static SicboSessionResponse fromEntity(SicboSession session, Instant referenceTime) {
        if (session == null) {
            return idle(referenceTime);
        }

        SicboSession.Phase phase = session.getPhase();
        ...
        return SicboSessionResponse.builder()
                ...
                .awaitingResult(phase == SicboSession.Phase.SHOW_RESULT)
